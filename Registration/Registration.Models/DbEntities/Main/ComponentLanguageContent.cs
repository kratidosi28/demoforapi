...
namespace Registration.Models.Main
{
    ...
    public partial class ComponentLanguageContent
    {
        ...
        [InverseProperty(nameof(Registration.Models.Main.LanguageContentKey.ComponentLanguageContents))]
        ...
        [InverseProperty(nameof(Registration.Models.Main.LanguageContent.ComponentLanguageContents))]
